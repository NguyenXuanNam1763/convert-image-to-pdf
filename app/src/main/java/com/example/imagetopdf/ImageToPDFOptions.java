...
public class ImageToPDFOptions extends PDFOptions {
    ...
    public String toString() {
        return "ImageToPDFOptions{" +
                "mQualityString='" + mQualityString + '\'' +
                ", mImagesUri=" + mImagesUri +
                ", mMarginTop=" + mMarginTop +
                ", mMarginBottom=" + mMarginBottom +
                ", mMarginRight=" + mMarginRight +
                ", mMarginLeft=" + mMarginLeft +
                ", mImageScaleType='" + mImageScaleType + '\'' +
                ", mPageNumStyle='" + mPageNumStyle + '\'' +
                ", mMasterPwd='" + mMasterPwd + '\'' +
                '}';
    }
}
